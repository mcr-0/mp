...
export default function TermsOfService() {
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <strong>OVERVIEW</strong> <br /> This website is operated by mazedpromos.
      Throughout the site, the terms “we”, “us” and “our” refer to mazedpromos.
      mazedpromos offers this website, including all information, tools and
      ...
      changes. <br /> <br /> <strong>SECTION 1 - ONLINE STORE TERMS</strong>{" "}
      ...
      to use this site. <br /> You may not use our products for any illegal or
      ...
      destructive nature. <br /> A breach or violation of any of the Terms will
      result in an immediate termination of your Services. <br /> <br />{" "}
      ...
      </strong> <br /> Certain products or services may be available exclusively
      ...
      Return Policy. <br /> We have made every effort to display as accurately
      as possible the colors and images of our products that appear at the
      store. We cannot guarantee that your computer monitors display of any
      color will be accurate. <br /> We reserve the right, but are not
      ...
      where prohibited. <br /> We do not warrant that the quality of any
      ...
      subject to these Terms of Service. <br />
      <br /> <strong>SECTION 8 - THIRD-PARTY LINKS</strong> <br /> Certain
      content, products and services available via our Service may include
      materials from third-parties. <br /> Third-party links on this site may
      ...
      websites. Please review carefully the third-partys policies and practices
      ...
      by email, by postal mail, or otherwise (collectively, comments), you agree
      ...
      obscene or otherwise objectionable or violates any partys intellectual
      ...
      updated. <br /> <br />
      <strong>SECTION 12 - PROHIBITED USES</strong> <br /> In addition to other
      ...
      or misleading information; (g) to upload or transmit viruses or any other
      ...
      any of the prohibited uses. <br /> <br />{" "}
      <strong>
      ...
      In no case shall mazedpromos, our directors, officers, employees,
      ...
      indemnify, defend and hold harmless mazedpromos and our parent,
      ...
      <br /> <br />
      <strong>SECTION 15 - SEVERABILITY</strong> <br /> In the event that any
      ...
      other remaining provisions. <br /> <br />{" "}
      ...
      be construed against the drafting party. <br /> <br />{" "}
      ...
      this page. <br /> We reserve the right, at our sole discretion, to update,
      ...
      Service constitutes acceptance of those changes. <br /> <br />
      <strong>SECTION 20 - CONTACT INFORMATION</strong> <br /> Questions about
      the Terms of Service should be sent to us at info@mazerewards.com.
    </div>
  );
}
